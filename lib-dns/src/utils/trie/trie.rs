            ...
            Some(node) => match node {
                ...
                Node::Branch(br) => {
                    let rep_key = {
                        ...
                        let ch = child_ref// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        ...
        loop {
            match cur {
                ...
                Node::Branch(b) => {
                    ...
                    cur = next// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
                }
            }
        }
    }
