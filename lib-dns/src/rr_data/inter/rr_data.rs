use crate::rr_data::{
    aaaa_rr_data::AaaaRRData, ch_a_rr_data::ChARRData, cname_rr_data::CNameRRData,
    dnskey_rr_data::DnsKeyRRData, ds_rr_data::DsRRData, hinfo_rr_data::HInfoRRData,
    https_rr_data::HttpsRRData, in_a_rr_data::InARRData, loc_rr_data::LocRRData,
    mx_rr_data::MxRRData, naptr_rr_data::NaptrRRData, ns_rr_data::NsRRData,
    nsec3_rr_data::NSec3RRData, nsec3param_rr_data::NSec3ParamRRData, nsec_rr_data::NSecRRData,
    ptr_rr_data::PtrRRData, rrsig_rr_data::RRSigRRData, smimea_rr_data::SmimeaRRData,
    soa_rr_data::SoaRRData, srv_rr_data::SrvRRData, sshfp_rr_data::SshFpRRData,
    svcb_rr_data::SvcbRRData, tkey_rr_data::TKeyRRData, tsig_rr_data::TSigRRData,
    txt_rr_data::TxtRRData, uri_rr_data::UriRRData,
};
...
impl dyn RRData {
    ...
    pub fn from_bytes_ambiguous(
        buf: &[u8],
        rtype: &RRTypes,
        class: &RRClasses,
    ) -> Result<Box<dyn RRData>, RRDataError> {
        Ok(match rtype {
            RRTypes::A => match class {
    ...
    pub fn from_wire(
        context: &mut FromWireContext,
        len: u16,
        rtype: &RRTypes,
        class: &RRClasses,
    ) -> Result<Box<dyn RRData>, WireError> {
        Ok(match rtype {
            RRTypes::A => match class {
