...
use crate::rr_data::{
    ...
    svcb_rr_data::SvcbRRData, txt_rr_data::TxtRRData, uri_rr_data::UriRRData,
};

#[allow(unused_imports)]
use crate::rr_data::{tkey_rr_data::TKeyRRData, tsig_rr_data::TSigRRData};
...
impl dyn ZoneRRData {
    pub fn new(rtype: RRTypes, class: &RRClasses) -> Option<Box<dyn ZoneRRData>> {
        Some(match rtype {
            ...
            RRTypes::NSec3Param => {
                <NSec3ParamRRData as ZoneRRData>::upcast(NSec3ParamRRData::default())
            }
