...
impl StateVerifier {
    ...
    pub fn manifests_equal(&self, domain1: &str, domain2: &str) -> bool {
    ...
    pub fn verify_persistence(
        &self,
        domain: &str,
        original_state: &serde_json::Map<String, Value>,
    ) -> bool {
        ...
        let same_cid =
            original_state.get("web4_manifest_cid") == current_state.get("web4_manifest_cid");
