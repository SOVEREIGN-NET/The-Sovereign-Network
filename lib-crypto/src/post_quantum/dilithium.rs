...
mod tests {
    ...
    fn test_dilithium2_sign_verify_roundtrip() {
        ...
        let signature = dilithium2_sign(message, &sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        let valid =
            dilithium2_verify(message, &signature, &pk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_dilithium5_sign_verify_roundtrip() {
        ...
        let signature = dilithium5_sign(message, &sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        let valid =
            dilithium5_verify(message, &signature, &pk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_auto_sign_detects_dilithium2() {
        ...
        let signature =
            dilithium_sign(message, &sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_full_auto_roundtrip_dilithium2() {
        ...
        let signature = dilithium_sign(message, &sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        let valid = dilithium_verify(message, &signature, &pk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_d2_signature_rejected_by_d5_key() {
        ...
        let signature = dilithium2_sign(message, &sk_d2)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_d5_signature_rejected_by_d2_key() {
        ...
        let signature = dilithium5_sign(message, &sk_d5)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_ios_d5_signature_verified_by_auto_detect() {
        ...
        // iOS signs with D5
        let signature = dilithium5_sign(message, &ios_sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_cli_d2_signature_verified_by_auto_detect() {
        ...
        // CLI signs with D2
        let signature = dilithium2_sign(message, &cli_sk)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
