...
use crate::types::{IspBypassWork, IspBypassWorkExt, WorkMetrics, WorkMetricsExt};
...
impl RewardDistribution {
    ...
    pub fn distribute_infrastructure_rewards(
        ...
        for (wallet, metrics) in participants.iter_mut() {
            let participant_work =
                metrics.routing_work + metrics.storage_work + metrics.compute_work;
            ...
            if reward_share > 0 {
                let reward = TokenReward {
                    ...
                    quality_bonus: if metrics.qualifies_for_quality_bonus() {
                        reward_share / 20
                    } else {
                        0
                    },
                    uptime_bonus: if metrics.qualifies_for_uptime_bonus() {
                        reward_share / 10
                    } else {
                        0
                    },
                ...
                info!(
                    "Distributed {} SOV infrastructure reward to participant",
                    reward_share
                );
            }
        }
        ...
        *self
        ...
        info!(
            "🏭 Distributed {} SOV total infrastructure rewards to {} participants",
            distributed_total,
            participants.len()
        );
    ...
    pub fn distribute_isp_bypass_rewards(
        ...
        let total_isp_work = participants
            .iter()
        ...
        for (wallet, work) in participants.iter_mut() {
            ...
            if reward_share > 0 {
                let reward = TokenReward {
                    ...
                    quality_bonus: if work.connection_quality > 0.9 {
                        reward_share / 10
                    } else {
                        0
                    },
                ...
                info!("Distributed {} SOV  reward to participant", reward_share);
            }
        }
        ...
        *self
        ...
        info!(
            "Distributed {} SOV total  rewards to {} participants",
            distributed_total,
            participants.len()
        );
    ...
    pub fn distribute_validation_rewards(
        ...
        for validator in validators.iter_mut() {
            if reward_per_validator > 0 {
                ...
                info!(
                    " Distributed {} SOV validation reward to validator",
        ...
        *self
        ...
        info!(
            " Distributed {} SOV total validation rewards to {} validators",
            distributed_total,
            validators.len()
        );
...
pub fn distribute_rewards(
    ...
    // Distribute rewards
    distribution
        .distribute_infrastructure_rewards(infrastructure_participants, infrastructure_pool)?;
    ...
    info!(
        "Completed reward distribution: {} SOV to {} participants",
