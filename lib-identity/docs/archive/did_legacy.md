# Legacy DID Documentation (Superseded)

This document is preserved for reference only. It contains older, mixed-method DID narratives and seed-anchored examples that do not reflect the current `did:zhtp` invariant.

See `docs/did.md` and ADR-0004 for the current system behavior.
