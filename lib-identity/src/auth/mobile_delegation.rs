...
mod tests {
    ...
    fn challenge_qr_payload_decodable() {
        ...
        let json_bytes = hex::decode(hex_part)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        let envelope: QrAuthEnvelope =
            serde_json::from_slice(&json_bytes)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
