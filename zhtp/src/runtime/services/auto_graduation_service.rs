...
mod tests {
    ...
    async fn test_auto_graduation_service() {
        ...
        let mut blockchain = Blockchain::new()// REMEDIATED PANIC: // REMEDIATED: .expect("Failed to create blockchain");
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("Failed to deploy token");
        ...
        blockchain
            .bonding_curve_registry
            .register(token)
            // REMEDIATED PANIC: // REMEDIATED: .expect("Failed to register token");
        ...
        let ready = service.manual_check().await// REMEDIATED PANIC: // REMEDIATED: .expect("Check failed");
