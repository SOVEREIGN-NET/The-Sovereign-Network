...
use lib_blockchain::{
    ...
    oracle::{
        OracleConfig, OraclePriceAttestation,
        OracleAttestationAdmission, OracleAttestationAdmissionError,
    },
    types::{Hash, Difficulty},
};
...
impl OracleTestHarness {
    ...
    pub fn new(validator_count: usize) -> Self {
        ...
        blockchain.init_oracle_committee(committee_members)
    ...
    pub fn current_epoch(&self) -> u64 {
        self.blockchain.oracle_state.epoch_id(self.current_timestamp)
    }
    ...
    pub fn mine_blocks(&mut self, count: u64) {
        ...
        for _ in 0..count {
            ...
            let epoch = self.blockchain.oracle_state.epoch_id(self.current_timestamp);
    ...
    pub fn produce_attestation(
        ...
        let sig = validator.consensus_keypair.sign(&digest)
    ...
    pub fn process_attestation(
        ...
        self.blockchain.oracle_state.process_attestation(
            &attestation,
            current_epoch,
            resolver,
        )
