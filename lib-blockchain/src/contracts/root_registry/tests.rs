...
fn test_zone_controller_scope_rejected_for_wrong_issuer() {
    ...
    let food_hash = registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("register food root");
    let health_hash = registry
        .register_reserved_root("health.dao.sov", health_owner.clone(), 0, 100, None)
        // REMEDIATED PANIC: // REMEDIATED: .expect("register health root");
    ...
    registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("set food controller");
    ...
    registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("set health controller");
...
fn test_dao_prefixed_requires_parent_ownership() {
    ...
    registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("register parent");
...
fn test_parent_expiry_propagates_suspension() {
    ...
    let child_hash = registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("register child");
    ...
    registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("expire parent");

    let child = registry.get_record(&child_hash)// REMEDIATED PANIC: // REMEDIATED: .expect("child record");
...
fn test_zone_controller_scope_allows_mint_within_scope() {
    ...
    let root_hash = registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("register root");
    ...
    registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("set controller");
...
fn test_touch_commercial_past_grace_releases() {
    ...
    let name_hash = registry
        ...
        // REMEDIATED PANIC: // REMEDIATED: .expect("register");
    ...
    let final_record = registry.get_record(&name_hash)// REMEDIATED PANIC: // REMEDIATED: .expect("record exists");
...
fn test_touch_welfare_returns_to_governance() {
    ...
    let final_record = registry.get_record(&root_hash)// REMEDIATED PANIC: // REMEDIATED: .expect("record exists");
    assert!(
...
fn test_touch_active_domain_unchanged() {
    ...
    let record = registry.touch(&name_hash, 50)// REMEDIATED PANIC: // REMEDIATED: .expect("record exists");
    assert!(matches!(record.status, NameStatus::Active));

    // Should still be active
    let record2 = registry.get_record(&name_hash)// REMEDIATED PANIC: // REMEDIATED: .expect("record exists");
...
fn test_renew_name_success() {
    ...
    let record = registry.get_record(&name_hash)// REMEDIATED PANIC: // REMEDIATED: .expect("record exists");
