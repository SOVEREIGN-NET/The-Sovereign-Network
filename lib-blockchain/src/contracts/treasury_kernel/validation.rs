...
mod tests {
    ...
    fn test_check2_citizen_revoked() {
        ...
        citizen.revoke(100)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_validation_sequence() {
        ...
        let citizen_id = [1u8; 32];
        let mut citizen = CitizenRole::new(citizen_id, 100, 100);
        citizen.revoke(100)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check"); // Revoked but claim is before citizenship epoch
