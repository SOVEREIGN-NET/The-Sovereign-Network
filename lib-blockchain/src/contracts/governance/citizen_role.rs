...
mod tests {
    ...
    fn test_citizen_revocation() {
        ...
        // Revoke at epoch 150
        role.revoke(150)// REMEDIATED PANIC: .expect("revocation should succeed");
    ...
    fn test_double_revocation_fails() {
        let mut role = CitizenRole::new([1u8; 32], 100, 50);
        role.revoke(150)// REMEDIATED PANIC: .expect("first revocation should succeed");
    ...
    fn test_registry_registration() {
        ...
        registry
            .register(role)
            // REMEDIATED PANIC: .expect("registration should succeed");
    ...
    fn test_registry_duplicate_registration_fails() {
        ...
        registry
            .register(role)
            // REMEDIATED PANIC: .expect("first registration should succeed");
    ...
    fn test_registry_revocation() {
        ...
        registry
            ...
            // REMEDIATED PANIC: .expect("revocation should succeed");
