...
impl HostFunctions {
    ...
    pub fn register_functions(linker: &mut wasmtime::Linker<Self>) -> Result<()> {
        ...
        linker.func_wrap(
            "env",
            "zhtp_log",
            |mut caller: Caller<'_, Self>, ptr: i32, len: i32| -> i32 {
        ...
        linker.func_wrap(
            "env",
            "zhtp_get_caller",
            |mut caller: Caller<'_, Self>, ptr: i32| -> i32 {
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, Self>| -> u64 { caller.data().context.block_number },
        )?;
        ...
        linker.func_wrap(
            "env",
            "zhtp_get_timestamp",
            |caller: Caller<'_, Self>| -> u64 { caller.data().context.timestamp },
        )?;
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, Self>,
             ...
             -> i32 {
                if key_len < 0
                    || key_len > MAX_STORAGE_KEY_SIZE as i32
                    || value_len < 0
                    || value_len > MAX_STORAGE_VALUE_SIZE as i32
                {
                ...
                if memory
                    ...
                    .is_err()
                    || memory
                        .read(&caller, value_ptr as usize, &mut value_buffer)
                        .is_err()
                {
