...
mod abi_tests {
    ...
    fn test_abi_serialization_round_trip() {
        ...
        let json = codec::AbiEncoder::encode_abi(&original)// REMEDIATED PANIC: .expect("Should encode ABI");

        let decoded = codec::AbiDecoder::decode_abi(&json)// REMEDIATED PANIC: .expect("Should decode ABI");
    ...
    fn test_abi_hash_consistency() {
        ...
        let hash1 = codec::AbiEncoder::abi_hash(&abi)// REMEDIATED PANIC: .expect("Should hash");
        let hash2 = codec::AbiEncoder::abi_hash(&abi)// REMEDIATED PANIC: .expect("Should hash");
    ...
    fn test_registry_management() {
        ...
        registry.register(abi1)// REMEDIATED PANIC: .expect("Should register UBI");
        registry.register(abi2)// REMEDIATED PANIC: .expect("Should register DevGrants");
    ...
    fn test_kernel_only_enforcement() {
        ...
        assert!(abi.methods[0].privilege.as_ref().ok().kernel_only);
    }
    ...
    fn test_rust_codegen() {
        ...
        let rust_code =
            codegen::AbiCodegen::generate_rust(&abi)// REMEDIATED PANIC: .expect("Should generate Rust code");
    ...
    fn test_ts_codegen() {
        ...
        let ts_code = codegen::AbiCodegen::generate_typescript(&abi)
            // REMEDIATED PANIC: .expect("Should generate TypeScript code");
    ...
    fn test_codegen_type_mapping() {
        ...
        let rust_code = codegen::AbiCodegen::generate_rust(&abi)// REMEDIATED PANIC: .expect("Should generate Rust");
        ...
        let ts_code =
            codegen::AbiCodegen::generate_typescript(&abi)// REMEDIATED PANIC: .expect("Should generate TypeScript");
