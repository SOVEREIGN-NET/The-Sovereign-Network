...
mod tests {
    ...
    fn test_rust_codegen() {
        ...
        let rust_code = AbiCodegen::generate_rust(&abi)// REMEDIATED PANIC: // REMEDIATED: .expect("Should generate Rust");
    ...
    fn test_ts_codegen() {
        ...
        let ts_code = AbiCodegen::generate_typescript(&abi)// REMEDIATED PANIC: // REMEDIATED: .expect("Should generate TypeScript");
