...
impl Transaction {
    ...
    /// Create a new Sovereign Asset launch transaction.
    pub fn new_asset_launch_with_chain_id(
        chain_id: u8,
        signature: Signature,
        memo: Vec<u8>,
    ) -> Self {
    ...
    /// Create a new rewards spend-delegate rotation transaction.
    pub fn new_asset_rewards_delegate_rotate_with_chain_id(
        chain_id: u8,
        signature: Signature,
        memo: Vec<u8>,
    ) -> Self {
        Transaction {
            version: TX_VERSION_V8,
            chain_id,
            transaction_type: TransactionType::AssetRewardsDelegateRotate,
            inputs: Vec::new(),
            outputs: Vec::new(),
            fee: 0,
            signature,
