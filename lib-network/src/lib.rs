...
pub use crate::identity::{PeerIdMapper, PeerMapperConfig, UnifiedPeerId};
...
pub use crate::peer_registry::{
    ...
    SharedPeerRegistry,
    DEFAULT_MAX_PEERS,
    DEFAULT_PEER_TTL_SECS,
};

// Peer Reputation System (Byzantine fault handling - Gap 6)
pub use crate::identity_store_forward::{IdentityQueueStats, IdentityStoreForward};
pub use crate::peer_reputation::{PeerReputation, PeerReputationManager, ReputationEvent};
...
pub use crate::handshake::{
    ChallengeProof, ChallengeResponse, ClientFinish, ClientHello, HandshakeCapabilities,
    HandshakeError, HandshakeErrorMessage, HandshakeMessage, HandshakePayload, HandshakeResult,
    NegotiatedCapabilities, NodeIdentity, ProvisionalHello, ServerHello, MIN_SUPPORTED_VERSION,
    UHP_VERSION, UHP_VERSION_STRING,
};
pub use lib_identity::{types::NodeId, ZhtpIdentity};

// Unified protocol encryption module (always available)
pub use crate::encryption::{
    create_encryption, ChaCha20Poly1305Encryption, EncryptionStats, ProtocolEncryption,
};
...
pub use crate::consensus_receiver::{ConsensusReceiver, ReceivedConsensusMessage};
...
pub mod types; // Protocol constants
...
pub use network_output::{global_output_queue, NetworkOutput, OutputQueue};
