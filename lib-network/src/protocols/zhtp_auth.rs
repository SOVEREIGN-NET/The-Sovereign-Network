...
pub struct ZhtpAuthManager {
    ...
    active_challenges:
        std::sync::Arc<tokio::sync::RwLock<std::collections::HashMap<String, ZhtpAuthChallenge>>>,
}
...
impl ZhtpAuthManager {
    ...
    pub fn new(node_blockchain_pubkey: PublicKey) -> Result<Self> {
        ...
        Ok(Self {
            ...
            active_challenges: std::sync::Arc::new(tokio::sync::RwLock::new(
    ...
    pub async fn create_challenge(&self) -> Result<ZhtpAuthChallenge> {
        ...
        info!(
            " Created ZHTP authentication challenge: {}",
            &challenge_id[..8]
        );
    ...
    pub fn respond_to_challenge(
        ...
        info!(
            " Responding to ZHTP authentication challenge: {}",
    ...
    pub async fn verify_response(
        ...
        info!(
            " Verifying ZHTP authentication response: {}",
            &response.challenge_id[..8]
        );
    ...
    pub async fn cleanup_expired_challenges(&self) {
        ...
        challenges.retain(|_, challenge| current_time.saturating_sub(challenge.timestamp) <= 300);
    }
}
...
pub enum ZhtpAuthMessage {
    ...
    ChallengeRequest { requester_pubkey: Vec<u8> },
