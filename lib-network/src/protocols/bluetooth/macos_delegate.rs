...
unsafe fn register_central_manager_delegate() {
    let superclass = AnyClass::get(c"NSObject")// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
...
pub unsafe fn create_central_manager_delegate_instance(
    ...
    let class =
        AnyClass::get(c"ZhtpCBCentralManagerDelegate")// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
...
pub unsafe fn create_peripheral_manager_delegate_instance(
    ...
    // Get the custom class
    let class =
        AnyClass::get(c"ZhtpCBPeripheralManagerDelegate")// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
