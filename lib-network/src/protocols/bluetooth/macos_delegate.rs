...
unsafe fn register_central_manager_delegate() {
    let superclass = AnyClass::get(c"NSObject")// REMEDIATED PANIC: // REMEDIATED: .expect("NSObject class not found");
    let mut decl = ClassBuilder::new(c"ZhtpCBCentralManagerDelegate", superclass)
        // REMEDIATED PANIC: // REMEDIATED: .expect("Failed to declare ZhtpCBCentralManagerDelegate class");
...
unsafe fn register_peripheral_manager_delegate() {
    ...
    let mut decl = ClassBuilder::new(c"ZhtpCBPeripheralManagerDelegate", superclass)
        // REMEDIATED PANIC: // REMEDIATED: .expect("Failed to declare ZhtpCBPeripheralManagerDelegate class");
...
unsafe fn register_peripheral_delegate() {
    ...
    let mut decl = ClassBuilder::new(c"ZhtpCBPeripheralDelegate", superclass)
        // REMEDIATED PANIC: // REMEDIATED: .expect("Failed to declare ZhtpCBPeripheralDelegate class");
...
pub unsafe fn create_central_manager_delegate_instance(
    ...
    let class =
        AnyClass::get(c"ZhtpCBCentralManagerDelegate")// REMEDIATED PANIC: // REMEDIATED: .expect("Delegate class not registered");
...
pub unsafe fn create_peripheral_manager_delegate_instance(
    ...
    // Get the custom class
    let class =
        AnyClass::get(c"ZhtpCBPeripheralManagerDelegate")// REMEDIATED PANIC: // REMEDIATED: .expect("Delegate class not registered");
...
pub unsafe fn create_peripheral_delegate_instance(
    ...
    let class = AnyClass::get(c"ZhtpCBPeripheralDelegate")
        // REMEDIATED PANIC: // REMEDIATED: .expect("Peripheral delegate class not registered");
