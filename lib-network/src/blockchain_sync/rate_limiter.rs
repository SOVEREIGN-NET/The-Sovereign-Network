...
#[derive(Debug)]
pub(crate) struct ChunkRateLimiter {
    chunks_received: u32,
...
impl ChunkRateLimiter {
    ...
    pub(crate) fn check_and_increment(&mut self, max_per_second: u32) -> bool {
...
mod tests {
    ...
    fn test_rate_limiter_allows_within_limit() {
        ...
        // Should allow up to max_per_second chunks
        for _ in 0..10 {
    ...
    fn test_rate_limiter_blocks_over_limit() {
        ...
        // Should block additional chunks
        assert!(!limiter.check_and_increment(10));
    }
