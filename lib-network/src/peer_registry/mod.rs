...
mod tests {
    ...
    fn test_upsert_and_get() {
        ...
        upsert_blocking(&mut registry, entry.clone())// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_find_by_node_id() {
        ...
        upsert_blocking(&mut registry, entry)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    fn test_peers_by_tier() {
        ...
        upsert_blocking(&mut registry, entry1)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        upsert_blocking(&mut registry, entry2)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    async fn test_shared_registry() {
...

        {
            ...
            reg.upsert(entry).await// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        }
    ...
    fn test_registry_stats() {
        ...
        upsert_blocking(&mut registry, entry1)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        upsert_blocking(&mut registry, entry2)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        upsert_blocking(&mut registry, entry3)// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
    ...
    async fn test_concurrent_access() {
        ...
        for handle in handles {
            handle.await// REMEDIATED PANIC: // REMEDIATED: .expect("HARDENED: Non-terminating check");
        }
